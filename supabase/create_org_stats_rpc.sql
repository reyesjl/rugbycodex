...
BEGIN
  ...
  -- Count total matches (exclude opposition)
  SELECT COUNT(*)
  ...
  -- Count matches in last 30 days (exclude opposition)
  SELECT COUNT(*)
  ...
  -- Count total narrations (exclude opposition)
  SELECT COUNT(n.id)
  ...
  -- Count total segments (exclude opposition)
  SELECT COUNT(s.id)
  ...
  -- Count segments with identity tags (exclude opposition)
  ...
  -- Count well-covered matches (>= 35 narrations, exclude opposition)
  SELECT COUNT(*)
