...
<template>
  <div v-if="errorMessage"
    class="mt-4 rounded-lg border border-rose-200 bg-rose-50 p-4 dark:border-rose-900/50 dark:bg-rose-900/20">
    <div class="flex items-start gap-3">
      <Icon icon="carbon:warning-square" class="h-5 w-5 text-rose-600 dark:text-rose-400 flex-shrink-0 mt-0.5" />
      <div>
