  ...
  <section class="base-container container flex min-h-screen flex-col gap-16 pt-32 pb-32">
    ...
    <template v-else-if="profile">
      ...
      <section
        ...
        <!-- Add Membership Form -->
        <div
          class="mt-6 rounded-xl border border-neutral-200 bg-white/50 p-6 dark:border-neutral-800 dark:bg-neutral-950/50">
          ...
          <div class="mt-4 space-y-4">
                ...
                <Transition enter-active-class="transition duration-100 ease-out"
                  ...
                  <div v-if="showOrgDropdown"
                    ...
                    <ul class="max-h-60 overflow-auto py-1">
                      <li v-if="availableOrganizations.length === 0"
                        class="px-4 py-3 text-sm text-neutral-500 dark:text-neutral-400">
                        No available organizations
                      </li>
                      <li v-for="org in availableOrganizations" :key="org.id" @click="selectOrganization(org.slug)"
                        :class="[
            ...
            <div>
              ...
              <CustomSelect v-model="selectedRole" :options="availableRoles" placeholder="Select role" />
            </div>
            ...
            <button type="button" @click="handleAddMembership" :disabled="!selectedOrgSlug || isAddingMembership"
    ...
    <ConfirmDeleteModal :show="showDeleteModal" :item-name="deleteText" :is-deleting="isDeletingMembership"
      :error="membershipDeleteError" :popup-title="'Remove Membership'" @confirm="confirmDeleteMembership"
