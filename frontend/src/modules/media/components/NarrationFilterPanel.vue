  ...
  <div class="space-y-4">
    ...
    <div class="relative">
      ...
      <input
        ...
        class="w-full border-0 border-b border-slate-700/50 bg-transparent py-2 pl-10 pr-3 text-sm text-slate-50 placeholder:text-slate-500 focus:outline-none focus:border-slate-300/60 transition"
