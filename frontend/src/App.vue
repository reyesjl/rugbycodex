...
<template>
  ...
  <section class="hero container flex min-h-screen flex-col items-center justify-center">
    <div class="text-neutral-400 mt-auto space-y-4">
      <img :src="heroImg" alt="Rugbycodex" class="lg:mt-20 w-80 md:w-100 lg:w-105 max-w-120 h-auto mx-auto animate-pulse" />
  ...
  <section class="container">
    <div class="micro-grid grid grid-cols-1 md:grid-cols-2 gap-16 text-neutral-900 dark:text-neutral-200">
      <div class="micro">
        <div class="micro-line h-1 bg-neutral-300 dark:bg-neutral-700"></div>
